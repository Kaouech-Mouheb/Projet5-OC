...
.catch(error => {
  ...
  .then((data) =>{
    productJs(data[2].name, data[2].imageUrl, data[2].description, data[2].price, data[2].lenses[0], data[2].lenses[1]);
  });
  const productJs = (titre, image, description, prix, lenses1, lenses2) =>{
    const product1 = document.getElementById("third-product");
    ...
    const descriptionJs = document.getElementById("third-product_description");
